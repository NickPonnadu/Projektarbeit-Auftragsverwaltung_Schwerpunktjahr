...
{
    partial class MainEditCustomer
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            LblCustomerPassword = new Label();
            TxtCustomerWebsite = new TextBox();
            TxtCustomerMail = new TextBox();
            LblCustomerWebsite = new Label();
            LblCustomerMail = new Label();
            TxtCustomerLocation = new TextBox();
            TxtCustomerPostcode = new TextBox();
            LblCustomerLocation = new Label();
            LblCustomerPostcode = new Label();
            TxtCustomerName = new TextBox();
            LblCustomerName = new Label();
            LblKunden = new Label();
            CmdEditCustomerSave = new Button();
            CmdEditCustomerCancel = new Button();
            TxtCustomerPhoneNumber = new TextBox();
            LblTxtCustomerPhoneNumber = new Label();
            TxtCustomerStreet = new TextBox();
            ...
            CmdEditCustomerSave.Click += CmdEditCustomerSave_Click;
            // 
            ...
            CmdEditCustomerCancel.Click += CmdEditCustomerCancel_Click;
            // 
            ...
            Controls.Add(TxtCustomerStreet);
            Controls.Add(LblTxtCustomerPhoneNumber);
            Controls.Add(TxtCustomerPhoneNumber);
            Controls.Add(CmdEditCustomerCancel);
            Controls.Add(CmdEditCustomerSave);
            Controls.Add(TxtCustomerPassword);
            Controls.Add(LblCustomerPassword);
            Controls.Add(TxtCustomerWebsite);
            Controls.Add(TxtCustomerMail);
            Controls.Add(LblCustomerWebsite);
            Controls.Add(LblCustomerMail);
            Controls.Add(TxtCustomerLocation);
            Controls.Add(TxtCustomerPostcode);
            Controls.Add(LblCustomerLocation);
            Controls.Add(LblCustomerPostcode);
