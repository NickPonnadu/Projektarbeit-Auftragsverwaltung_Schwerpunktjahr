namespace Projekt_Auftragsverwaltung
{
    partial class MainEditCustomer
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.CmdEditCustomerSave.Click += new System.EventHandler(this.CmdEditCustomerSave_Click);
            // 
            ...
            this.Controls.Add(this.LblCustomerPassword);
            this.Controls.Add(this.TxtCustomerWebsite);
            this.Controls.Add(this.TxtCustomerMail);
            this.Controls.Add(this.LblCustomerWebsite);
            this.Controls.Add(this.LblCustomerMail);
            this.Controls.Add(this.TxtCustomerLocation);
            this.Controls.Add(this.TxtCustomerPostcode);
            this.Controls.Add(this.LblCustomerLocation);
            this.Controls.Add(this.LblCustomerPostcode);
